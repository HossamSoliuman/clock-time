...
@section('description', 'Plan meetings effortlessly across time zones with our free meeting planner. Easily coordinate schedules in different cities and countries, view time differences, and find the best meeting times for all participants.')
@section('keywords', 'meeting schedule,free meeting scheduler,time zone event planner,timezone event planner,time and date meeting planner,meeting time zone planner,meeting planner, time zone planner, schedule across time zones, free meeting planner, international meeting scheduler, global time scheduler, multi-time zone planner, time zone converter, world meeting planner, cross-time zone meetings, time zone scheduler, online meeting planner, global meeting coordinator, city time planner, remote meeting scheduler, time zone calculator, worldwide meeting tool, best meeting time, time difference planner, global time coordination')
...
@section('container')
    ...
    @include('front.sections.meeting-planner')
