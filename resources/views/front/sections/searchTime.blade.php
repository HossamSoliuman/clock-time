...
<section class="searchSection py-5">
    ...
    <div class="container">
        <div class="text-center">
            <h2>Search Time Zone</h2>
        </div>
        <div class="w-50 m-auto">
            <form id="searchTime" action="{{ url('get-convert-tz-tz') }}" method="GET" onsubmit="return searchTime(event);">
                <div class="row mt-3">
                    <div class="col-lg-9 mb-3 position-relative">
                        ...
                        <input name='mode-select2' placeholder="Search for TimeZone..." class="w-100 rounded-2 ps-3"
                            required />
                    </div>
