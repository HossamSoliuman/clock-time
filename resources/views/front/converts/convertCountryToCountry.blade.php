                    ...
                    <div class="col-lg-5 mb-3 col-sm-6">
                        <div class="card bg-white px-3 py-1">
                            <div class="d-flex justify-content-between align-items-center  h-100">
                                <h4 id="country1" style="font-family: Lexend,serif;font-size: 24px " class="col-7">Egypt</h4>
                                <h3 class="second mb-0" style="font-family: Lexend,serif;font-size: 32px">03:45 PM</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 mb-3 col-sm-6">
                        <div class="card bg-white px-3 py-1">
                            <div class="d-flex justify-content-between align-items-center  h-100">
                                    <h4 id="country2" style="font-family: Lexend,serif;font-size: 24px " class="col-7"></h4>
                                    <h3 class="second mb-0" style="font-family: Lexend,serif;font-size: 32px">03:45 PM</h3>
                                </div>
                            </div>
                        </div>
