...
<section class="searchSection py-5" style="background-color: rgba(33, 37, 66, 1)">
    <div class="container">
        <div class="text-center">
            <h2 class="text-white">Search City Time Inside {{$data['country']->name}}</h2>
        </div>
            ...
            <form id="timeZoneForm4" action="{{ url('/') }}" method="GET" onsubmit="return changeAction4(event);">
                <div class="row mt-3">
                    <div class="col-lg-9 mb-3 position-relative">
                        ...
                        <input name='mode-select2' placeholder="Search for your city..." class="w-100 rounded-2 ps-3 bg-white"
                            required />
                    </div>
...
var tagify2;
    $(document).ready(function() {
        ...
        tagify2.on('input', function(e) {
            $.ajax({
                url: '{{ url('fetch-country-city/'.$data['country']->id) }}',
                type: 'get',
                data: {
