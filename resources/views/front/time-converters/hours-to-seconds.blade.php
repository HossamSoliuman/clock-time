...
@section('section')
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card p-4 mb-3">
                    <h5><i class="fa fa-calculator me-2 mb-3"></i> Convert hours to seconds</h5>
                    <div class="mb-3 d-flex gap-3 justify-content-center">
                        <label><i class="fa fa-hourglass me-2 d-inline" style="font-size: 16px"></i>Hours</label>
                        <input type="number" class="form-control" id="hours" value="0" step="any">
                    </div>
                    <button class="btn btn-convert w-100 mb-2" onclick="convertHoursToSeconds()">
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card p-3 text-center">
                            <div><i class="fa fa-clock me-2"></i>Total Minutes</div>
                            <div class="fs-4 fw-bold" id="totalMinutes">0.00</div>
                            <div>minutes</div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="card p-3 text-center">
                            <div><i class="fa fa-calendar-day me-2"></i>Total Days</div>
    ...
    <script>
        function convertHoursToSeconds() {
            ...
            document.getElementById('totalMinutes').innerText = totalMinutes.toFixed(2);
            document.getElementById('totalDays').innerText = totalDays.toFixed(2);

            let input = `${h} hours`;
            let output = `${totalSeconds} seconds, ${totalMinutes.toFixed(2)} minutes, ${totalDays.toFixed(2)} days`;
        ...
        function resetAll() {
            ...
            document.getElementById('totalMinutes').innerText = '0.00';
