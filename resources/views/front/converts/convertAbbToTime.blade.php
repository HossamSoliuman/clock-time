            ...
            <form id="abbTotz" action="{{ url('get-convert-tz-tz') }}" method="GET">
                <div class="row">
                    <div class="col-lg-5 mb-3 position-relative">
                        ...
                        <input name="mode-select" placeholder="Search Time Zones..."
                               class="w-100 rounded-2 ps-3 bg-white"
                               required/>
                    </div>
                    <div class="col-lg-5 mb-3 position-relative">
                        <i class="fa-solid fa-location-dot position-absolute top-50 "
                ...
                <div class="row converterUTC mt-3 " style="display: none">
                    <div class="col-lg-5 mb-3">
                        <div class="card bg-white p-3">
                            <div class="d-flex justify-content-between  h-100">
                                <h3 class="first mb-0 col-6" id="abb" style="font-family: Lexend,serif;font-size: 22px">
                                    UTC+2</h3>
                                <h3 class="second mb-0" id="abb_time" style="font-family: Lexend,serif;font-size: 24px">
                                    UTC+2</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 mb-3">
                        <div class="card bg-white p-3">
                            <div class="d-flex justify-content-between  h-100">
                                <h3 class="first mb-0 col-6" id="tz" style="font-family: Lexend,serif;font-size: 22px">
                                    UTC+2</h3>
                                <h3 class="second mb-0" id="tz_name" style="font-family: Lexend,serif;font-size: 24px">
                                    UTC+2</h3>
                            </div>
                        </div>
                    </div>
