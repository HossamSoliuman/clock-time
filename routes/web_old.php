...
Route::get('/convert-gmt/{gmt}/to/{utc}', [ConvertGmtController::class, 'convertTime'])->name('convert.gmt.to.time');
...
Route::get('/fetch-country-city/{country_id}', [CityController::class, 'ByCountry'])->name('fetch.country.city');
